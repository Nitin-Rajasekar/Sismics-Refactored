...
import com.sismics.music.core.service.spotify.SpotifyRecommendationsStrategy;

import com.sismics.music.rest.resource.command.*;
...
public class UserResource extends BaseResource {
    ...
    public Response lastFmSearch(@QueryParam("song") String song) throws IOException {
        ...
        LastFmServiceCommand searchCommand = new LastFmSearchCommand(song, lastFmService);
    ...
    public Response lastFmRecommendations(@QueryParam("seed_mbids") String seed_mbids) throws IOException {
        if (!authenticate()) {
            throw new ForbiddenClientException();
        }
        ...
        LastFmServiceCommand recommendationsCommand = new LastFmRecommendationsCommand(seed_mbids, lastFmService);
    ...
    public Response search(@QueryParam("song") String song) throws IOException {
        ...
        SpotifyServiceCommand searchCommand = new SpotifySearchCommand(song, SpotifySearch);
    ...
    //function with input of string array of track ids
    public Response recommend(@QueryParam("seed_tracks") String seed_tracks) throws IOException {
        
        SpotifyServiceInvoker invoker = new SpotifyServiceInvoker();
        SpotifyApiRequestStrategy SpotifyRecommend = new SpotifyRecommendationsStrategy();

        SpotifyServiceCommand recommendationsCommand = new SpotifyRecommendationsCommand(seed_tracks, SpotifyRecommend);
