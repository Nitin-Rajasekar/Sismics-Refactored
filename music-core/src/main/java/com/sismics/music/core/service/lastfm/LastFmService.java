...
public class LastFmService extends AbstractScheduledService {
    ...
    public static String search(String song) throws IOException{
        String API_KEY = "a5f435a6851cf94f7fb581ba969709a4";
        String API_BASE_URL = "http://ws.audioscrobbler.com/2.0/";
        String API_METHOD = "track.search";

        String url =  API_BASE_URL + "?method=" + API_METHOD + "&api_key=" + API_KEY + "&format=json&track=" + song;
    ...
    public static String recommend(String seed_mbids) throws IOException {
        String API_KEY = "a5f435a6851cf94f7fb581ba969709a4";
        String API_BASE_URL = "http://ws.audioscrobbler.com/2.0/";
        String API_METHOD = "track.getsimilar";
        String limit = "3";

        String recommended_tracks = "";


        for (String mbid : seed_mbids.split(",")) {
            if(mbid==""){
                continue;
            }
            String url = API_BASE_URL + "?method=" + API_METHOD + "&api_key=" + API_KEY + "&format=json&limit=" + limit + "&" + "mbid=" + mbid;
            ...
            recommended_tracks += jsonResponse;
