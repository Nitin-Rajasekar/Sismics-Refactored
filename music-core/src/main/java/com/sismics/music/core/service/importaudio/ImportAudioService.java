...
public class ImportAudioService extends AbstractExecutionThreadService {
    ...
    private ImportAudioFile guessTags(File file) {
        ...
        try {
            ...
            importAudioFile.setUser_filter(tag.getFirst(FieldKey.CUSTOM1));
            // Read track album
    ...
    public void tagFile(final String fileName, final Integer order, final String title, final String album, final String artist,
            final String albumArtist, final Directory directory, final String user_filter) throws Exception {
        syncExecutor.submit((Callable<Void>) () -> {
            ...
            try {
                ...
                tag.setField(FieldKey.CUSTOM1, user_filter);
                ...
                throw new Exception("Error taggihrhshsrsgfhgng the file", e);
            }
            //System.out.println(tag);
            System.out.println("\n\n\n\n\n\n\n\n\n\n\n");
